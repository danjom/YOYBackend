...
namespace YOY.DAO.Entities.Manager
{
    public class CashIncentiveManager
    {
                ...
                if (query != null)
                {
                    ...
                    foreach (OltpcashIncentives item in query)
                    {
                        ...
                        cashbackIncentive = new CashIncentive
                        {
                            ...
                            MinPurchasedAmountToBeApplied = item.MinPurchasedAmountToBeApplied,
                            ...
                            ApplyToInAppPurchases = item.AppliesToInAppPurchases,
                            ...
                            MinPurchasedAmountToCount = item.MinPurchasedAmountToCount,
        ...
        /// <returns></returns>
        public CashIncentive Post(int type, int displayType, int applyType, int benefitAmountType, int dealType, decimal unitValue, decimal previousUnitValue, int minMembershipLevel, decimal minPurchasedAmountToBeApplied, 
            decimal purchasedAmountBlock, decimal maxValue, int availableQuantity, string name, string mainHint, string complementaryHint, string description, string keywords, bool appliesToInAppPurchases, bool isSponsored, string validWeekDays, 
            string validHours, int maxUsagesPerUser, DateTime? purchasesCountStartDate, int minPurchasesCountToUse, decimal minPurchaseAmountToCount, int geoSegmentationType, string rules, 
            string conditions, double relevanceRate, DateTime releaseDate, DateTime expirationDate)
        {
            ...
            try
            {
                newCashbackIncentive = new OltpcashIncentives
                {
                    ...
                    MinPurchasedAmountToBeApplied = minPurchasedAmountToBeApplied,
                    ...
                    Keywords = keywords,
                    AppliesToInAppPurchases = appliesToInAppPurchases,
                    IsActive = true,
                    ...
                    MinPurchasedAmountToCount = minPurchaseAmountToCount,
                    UsageCount = 0,
                ...
                cashbackIncentive = new CashIncentive
                {
                    ...
                    MinPurchasedAmountToBeApplied = newCashbackIncentive.MinPurchasedAmountToBeApplied,
                    ...
                    ApplyToInAppPurchases = newCashbackIncentive.AppliesToInAppPurchases,
                    ...
                    MinPurchasedAmountToCount = newCashbackIncentive.MinPurchasedAmountToCount,
        ...
        /// <returns></returns>
        public CashIncentive Put(Guid id, int type, int displayType, int applyType, int benefitAmountType, int dealType, decimal unitValue, decimal previousUnitValue, int minMembershipLevel, decimal minPurchasedAmountToBeApplied,
            decimal purchasedAmountBlock, decimal maxValue, int availableQuantity, string name, string mainHint, string complementaryHint, string description, string keywords, bool appliesToInAppPurchases, bool isSponsored, string validWeekDays,
            string validHours, int maxUsagesPerUser, DateTime? purchasesCountStartDate, int minPurchasesCountToUse, decimal minPurchaseAmountToCount, int geoSegmentationType, string rules,
            string conditions, double relevanceRate, DateTime releaseDate, DateTime expirationDate)
        {
            ...
            try
            {
                ...
                if (currentCashbackIncentive != null)
                {
                    ...
                    currentCashbackIncentive.MinPurchasedAmountToBeApplied = minPurchasedAmountToBeApplied;
                    ...
                    currentCashbackIncentive.AppliesToInAppPurchases = appliesToInAppPurchases;
                    ...
                    currentCashbackIncentive.MinPurchasedAmountToCount = minPurchaseAmountToCount;
                    ...
                    cashbackIncentive = new CashIncentive
                    {
                        ...
                        MinPurchasedAmountToBeApplied = currentCashbackIncentive.MinPurchasedAmountToBeApplied,
                        ...
                        ApplyToInAppPurchases = currentCashbackIncentive.AppliesToInAppPurchases,
                        ...
                        MinPurchasedAmountToCount = currentCashbackIncentive.MinPurchasedAmountToCount,
                                ...
                                if (item.AvailableQuantity == -1 || item.AvailableQuantity > 0)
                                {
                                    incentiveData = new FlattenedCashIncentiveData
                                    {
                                        ...
                                        CashIncentive = new DisplayCashIncentiveData
                                        {
                                            ...
                                            Description = item.Description,
                                            Keywords = item.Keywords,
                                            AppliesToInAppPurchases = item.AppliesToInAppPurchases,
                                            IsSponsored = item.IsSponsored,
                                            IsActive = item.IsActive,
                                            ValidWeekDays = item.ValidWeekDays,
                                            ValidHours = item.ValidHours,
