...
{
    public partial class Oltpoffers
    {
        public Oltpoffers()
        {
            OltpofferPreferences = new HashSet<OltpofferPreferences>();
        ...
        public int? SecondsIncentiveVariationFrame { get; set; }
        ...
        public virtual Oltpcategories MainCategory { get; set; }
        public virtual Deftenants Tenant { get; set; }
        public virtual Oltprewards Oltprewards { get; set; }
        public virtual ICollection<OltpofferPreferences> OltpofferPreferences { get; set; }
