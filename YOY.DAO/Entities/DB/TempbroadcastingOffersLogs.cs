...
{
    public partial class TempbroadcastingOffersLogs
    {
        ...
        public Guid LogRecordReferenceId { get; set; }
        public int LogRecordReferenceType { get; set; }
        public DateTime LogRecordExpirationDate { get; set; }
